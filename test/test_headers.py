...
def test_header_randomization():
    ...
    assert header.get_random_header() == (
    ...
    ) and header.get_random_header() == (
        "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.1; Win64; x64; "
        "Trident/7.0; .NET CLR 2.0.50727; SLCC2; .NET CLR 3.5.30729; .NET "
        "CLR 3.0.30729; Media Center PC 6.0; .NET4.0C; .NET4.0E; "
        "InfoPath.3; Tablet PC 2.0; MDDRJS)"
    )
